...
%fuselage
plane.geo.body.W = 5 + rand()*(30 - 5); %ft, fuselage width
...
plane.geo.wing.S = 350 + rand()*(900 - 350); %ft^2, wing area
plane.geo.wing.AR = 5 + rand()*(20 - 5); %wing aspect ratio
...
plane.geo.wing.sweep = 0 + rand()*(45-0); %degrees, sweep length
...
plane.geo.h_tail.sweep = 0 + rand()*(20-0); %degrees, sweep length
...
plane.geo.v_tail.S = 10 + rand()*(300 - 30); %ft^2, v_tail area
plane.geo.v_tail.AR = 3 + rand()*(10 - 3); %v_tail aspect ratio
