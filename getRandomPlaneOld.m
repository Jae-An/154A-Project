...
plane.geo.body.tank_length = [(V_tank - (8*3.1415/3)*(plane.geo.body.D/2)^3)/(3.1415*(plane.geo.body.D/2)^2)]+plane.geo.body.D;
...
plane.geo.wing.S = 500 + rand(1)*(1500 - 500); %ft^2, wing area
...
plane.geo.h_tail.AR = 2 + rand(1)*(9 - 2); %h_tail aspect ratio
...
plane.geo.v_tail.AR = 2 + rand(1)*(9 - 2); %v_tail aspect ratio
...
plane.prop.fuel_mass = 1000 + rand(1)*(3000 - 1000); %lb - guess based off of bessieMk3
