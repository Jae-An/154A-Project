...
%% ROC = (Pav - Preq) / W
Pav = plane.prop.numengines * plane.prop.hp * 550; % lb-ft/s

S = plane.geo.wing.S; %ft2
...
rho = 0.00238; % slug/ft3
V_ref = (Dry_weight/(0.5*rho*CL_maxRC*S))^0.5; %ft/s
...
R1 = (eta_p / c_p) * LD(1) * log(weightInitial1/weightFinal1);
R2 = (eta_p / c_p) * LD(1) * log(weightInitial2/weightFinal2);
