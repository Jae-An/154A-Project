...
c = plane.prop.c_p;
eta_p = max(plane.prop.eta_p); %assuming flying at cruise speed with maximum propellar efficiency
R1 = (eta_p / c) * LD(1) * log(weightInitial1/weightFinal1);
R2 = (eta_p / c) * LD(1) * log(weightInitial2/weightFinal2);
