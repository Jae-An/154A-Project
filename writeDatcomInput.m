...
fprintf(fid,'ZCG=%.2f, ',0.0); % vertical location of CG relative to reference plane
...
fprintf(fid,'ALIW=%.2f, ',0.0); % wing root chord incidence angle measured from reference plane
fprintf(fid,'XH=%.2f,',0.9*plane.geo.body.L); % longitudinal location of theoretical horizontal tail apex
fprintf(fid,'\n   ZH=%.2f, ',0.0); % vertical location of theoretical horizontal tail apex relative to reference plane
fprintf(fid,'ALIH=%.2f, ',0.0); % horizontal tail root chord incidence angle measured from reference plane
