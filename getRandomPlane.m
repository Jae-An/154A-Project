...
plane.geo.h_tail.ac = plane.geo.wing.cg + plane.geo.h_tail.cg + 0.25*plane.geo.h_tail.c/plane.geo.h_tail.c; %ft, distance from wing leading edge to AC, set to quarter chord
