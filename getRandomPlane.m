...
plane.geo.wing.S = 400 + rand(1)*(1000 - 400); %ft^2, wing area
plane.geo.wing.b = 60 + rand(1)*(200 - 60); %ft, wingspan
...
plane.geo.wing.LE = (0.1*plane.geo.body.L) + rand(1)*(plane.geo.body.L*(0.7-0.1));
